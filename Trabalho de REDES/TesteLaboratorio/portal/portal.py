...
# Lista de servidores
servers = [("172.26.2.149", 9001), ("172.26.2.149", 9002), ("172.26.2.149", 9003)] #Ips de onde estao os servidores, onde eles ficam ouvindo [IP_OndeServOuve]
IP_OndePortalOuve = ['172.26.2.143']
IP_PORTA_OndeClienteOuve = ['172.26.2.139', 8002] 
...
def tratarCliente(client_socket, mode, RR):
    ...
    try:
        ...
        enviar_string(client_socket.getpeername()[0], IP_PORTA_OndeClienteOuve[1], resultado_final)
        client_socket.close()
        return RR
