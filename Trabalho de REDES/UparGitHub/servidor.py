...
IP_PORTA_OndePortalOuve = ['192.168.11.139', 8001] #Porta 8001 usada como padrão para retorno de resultados
IP_OndeServOuve = ['192.168.11.139'] #Precisa ser a mesma que o pc onde o servidor esta
