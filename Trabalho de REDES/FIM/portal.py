...
IP_OndePortalOuve = ['192.168.11.107']
...
def receber_resultado(ip, port):
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as recebe:
        ...
        recebe.bind((IP_OndePortalOuve[0], port)) #|PORTA 8001 |Precisa ser a mesma porta que na linha 68 do codigo do servidor (IP onde esta o IP_PORTA_OndePortalOuve) 
        recebe.listen(1)
        resultado = ""
