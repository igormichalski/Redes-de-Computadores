...
IP_PORTA_OndeClienteOuve = ['192.168.11.107', 8002] #(proprio ip do pc onde esta o cliente)
...
def receber_resultado():
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as recebe:
        ...
        #teste
        recebe.bind((IP_PORTA_OndeClienteOuve[0], IP_PORTA_OndeClienteOuve[1])) #ip do portal
        recebe.listen(1)
        resultado = ""
