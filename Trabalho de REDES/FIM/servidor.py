...
IP_PORTA_OndePortalOuve = ['192.168.11.107', 8001] #Porta 8001 usada como padrão para retorno de resultados
IP_OndeServOuve = ['192.168.11.137'] #Precisa ser a mesma que o pc onde o servidor esta
...
def handle_portal(portal_socket):
    try:
        ...
        if file_name:
            ...
            enviar_string(IP_PORTA_OndePortalOuve[0], IP_PORTA_OndePortalOuve[1], result) #ip de onde esta o portal
...
def main():
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        ...
        server_socket.bind((IP_OndeServOuve[0], port)) #ip onde esta o servidor
